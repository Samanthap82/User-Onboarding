describe('User Onboarding Project Page', () => {
    ...
    it('testing inputs', () => {
        nameInput().type('Samantha Prewitt').should('have.value', 'Samantha Prewitt');

        emailInput().type('samanthaprewitt@gmail.com').should('have.value', 'samanthaprewitt@gmail.com');
